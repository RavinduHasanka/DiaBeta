                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Prediabetes Prediction</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <form action="heartscore.php" method="post">
                    <div class="form-group">
                        ...
                        <br/>
                        <h3>Questions 3 : Do you have Polyuria?</h3>
                            <div class="form-group"> 
                                <ol>
                                    <li>
                        ...
                        <h3>Questions 4 : Do you have Polydipsia? </h3>
                            <div class="form-group"> 
                                <ol>
                                    <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 5 : Have you had sudden weight loss?</h3>
                            <ol>
                                <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 6 : Do you feel Irritability?</h3>
                            <ol>
                                <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 7 : Do you have Delayed Healing?</h3>
                            <ol>
                                <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 8 : Do you have Partial Paresis?</h3>
                            <ol>
                                <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 9 : Do you have Alopecia?</h3>
                            <ol>
                                <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 10 : Do you have Visual Blurring?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q9" value="1" />&nbsp;&nbsp;Yes
                                </li>
