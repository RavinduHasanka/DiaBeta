...
<body>
    ...
    <div class="breadcrumb-area">
        <!-- Top Breadcrumb Area -->
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/2.jpg);">
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Heart Risk Prediction</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <form action="heartscore.php" method="post">
                    <div class="form-group">
                        ...
                        <h3>Questions 4 :Blood Pressure? </h3>
                            <div class="form-group"> 
                                <ol>
                                    <li>
                    ...
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 5 : Smoking Status?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q5" value="1" />&nbsp;&nbsp;Never 
                                </li>
                                <li>
                                    <input type="radio" name="q5" value="2" />&nbsp;&nbsp;Non Smoker less than 10 year
                                </li>
                                <li>
                                    <input type="radio" name="q5" value="3" />&nbsp;&nbsp;Current Smoker less than 10 year
                                </li>
                                <li>
                                    <input type="radio" name="q5" value="4" />&nbsp;&nbsp;Current Smoker over than 10 year
                                </li>
                            </ol>
                    </div>
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 6 : Diabetes Status?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q6" value="1" />&nbsp;&nbsp;Absent
                                </li>
                                <li>
                                    <input type="radio" name="q6" value="2" />&nbsp;&nbsp;Type I
                                </li>
                                <li>
                                    <input type="radio" name="q6" value="3" />&nbsp;&nbsp;Type II
                                </li>
                            </ol>
                    </div>
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 7 : Activity level ?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q7" value="1" />&nbsp;&nbsp;4 or more time / week
                                </li>
                                <li>
                                    <input type="radio" name="q7" value="2" />&nbsp;&nbsp;2 - 3 time / week
                                </li>
                                <li>
                                    <input type="radio" name="q7" value="3" />&nbsp;&nbsp;0 - 1 time / week
                                </li>
                            </ol>
                    </div>
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 8 : Cholesterol Level?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q8" value="1" />&nbsp;&nbsp;Below 200 
                                </li>
                                <li>
                                    <input type="radio" name="q8" value="2" />&nbsp;&nbsp;Above 200
                                </li>
                            </ol>
                    </div>
                    <br/>
                    <div class="form-group"> 
                        <h3>Questions 9 : Stress Level?</h3>
                            <ol>
                                <li>
                                    <input type="radio" name="q9" value="1" />&nbsp;&nbsp;Don't Stress
                                </li>
                                <li>
                                    <input type="radio" name="q9" value="2" />&nbsp;&nbsp;Feel stress 1 - 2 times
                                </li>
                                <li>
                                    <input type="radio" name="q9" value="3" />&nbsp;&nbsp;Stress mostday
                                </li>
                                <li>
                                    <input type="radio" name="q9" value="4" />&nbsp;&nbsp;Stress everyday
                                </li>
                            </ol>
                    </div>
                    <br><br>
